package nrg.inc.bykerz.report.domain.service;
...
public interface ReportQueryService {
    Report handle(GetReportByIdQuery query);
    List<Report> handle(GetReportByVehicleIdQuery query);
    List<Metric> handle(GetMetricsByReportIdQuery query);
